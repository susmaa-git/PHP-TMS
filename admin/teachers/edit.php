    ...
    <div class="container w-50">
        ...
        <form action="#" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input type="text" value = "<?php   echo $data['name']; ?>"       class="form-control" name="name"   id="exampleInputName" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control"   value = "<?php   echo $data['address']; ?>"     name = "address" id="exampleInputaddress" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
                <label for="exampleInputfaculty" class="form-label">faculty:</label>
                <input type="text" class="form-control"  value = "<?php   echo $data['faculty']; ?>"  name = "faculty" id="exampleInputfaculty" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
                <label for="exampleInputqualification" class="form-label">Qualification:</label>
                <input type="text" class="form-control" name="qualification"     value = "<?php   echo $data['qualification']; ?>"    id="exampleInputqualification" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
